...
--
-- Host: localhost    Database: empresabd
-- ------------------------------------------------------
...
CREATE TABLE `depto_localizacoes` (
  ...
  `DNumero_Departamento` int DEFAULT NULL,
  PRIMARY KEY (`LNumero`),
...
CREATE TABLE `empregado` (
  ...
  `SSN_Supervisor` bigint DEFAULT NULL,
  `DNumero_Departamento` int DEFAULT '1',
  PRIMARY KEY (`SSN`),
...
INSERT INTO `trabalha_em` VALUES ('1', '1', '40'),('3', '1', '40'),('4', '1', '20'),('4', '3', '20'),('2', '3', '40'),('5', '3', '20');
