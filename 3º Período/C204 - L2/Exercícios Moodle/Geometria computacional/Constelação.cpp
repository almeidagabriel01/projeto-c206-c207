...
int main()
{
  int N, i; // numero de pontos e o contador do for
  ponto estrelas[100]; // vetor de pontos
  list <ponto> fecho; // lista de pontos que compoem o fecho convexo
  int lados = 0; // numero de lados do poligono
